...
export default function WhyChooseSection() {
    return (
        <section className="relative overflow-hidden bg-slate-950 px-5 py-16 sm:px-8 sm:py-20 lg:px-12 lg:py-24">
            {/* Background Glow */}
            ...
            <div className="relative mx-auto max-w-7xl">
                ...
                <div className="mx-auto max-w-3xl text-center">
                    <span className="mb-4 inline-flex rounded-full border border-cyan-400/20 bg-cyan-400/5 px-4 py-2 text-xs font-semibold uppercase tracking-[0.2em] text-cyan-300">
                        Why SkillZen
                    </span>
                ...
                <div className="mt-12 grid gap-5 sm:mt-14 sm:grid-cols-2 lg:gap-6">
                    ...
                    {whyChooseData.map((item) => (
                        <article key={item.id} className="group rounded-2xl border border-slate-800 bg-slate-900/50 p-6 transition-all duration-300 hover:-translate-y-1 hover:border-cyan-400/30 hover:bg-slate-900 sm:p-7 lg:p-8">
